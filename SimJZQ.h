...
public:
	...
	//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	  ...
	  INT8U  HostSendRcv376_2MsgAddrBuf(INT8U vSrcCn,INT8U * vSrcMsgAddr,INT8U vSrcAFN,INT16U vSrcFn,INT8U *vSrcBuf,INT16U vSrcLen,sPartQGDW376_2CreatFrame &sQGDW376_2HostFrame,TH_OUT sPartQGDW376_2DeCodeFrame &DstDecodeDataFrame,INT8U vSrcAckCmp = 0);
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	...
	//-------------------------------------------------
	//【函数名称】 WaitStrAck(INT16U nWaitFramTime , INT16U nWaiteByteTime,TH_OUT CString &str);
	//【函数功能】  等待数据的返回
	//【参数说明】        
	//【I:	输入】   famedly：帧延时   bytedly：字节延时 Str: 返回的信息内容字符串
	//【O:	输出】    
	//【返回值	】    
	//【全局变量】       
	//【特殊说明】           
	//【开发者	】  刘存  【日期】 2017年8月30日
	//【描  　述】 原始版本
	//-------------------------------------------------
	//【修改人	】     【日期】
	//【描  　述】
	//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	  INT8U  WaitStrAck(INT32U nWaitFramTime , INT16U nWaiteByteTime,TH_OUT INT8U * recvbuf);
	  void GetCOMMStrToBuf(INT16U  getLen , INT32U nWaitFramTime , INT16U nWaiteByteTime ,INT8U * recvbuf,INT16U &recvlen);
