...
struct PartQGDW376_2
{
	INT8U	 s_Con;				//控制欲
	INT8U    s_MsgBuf[6+1];       //信息域
	INT8U    s_MainAddBuf[6+1];   //主结点地址，源地址
	INT8U    s_RelayAddBuf[DZB_MAXZJ_CNT*6+1];//中继地址
	INT8U    s_DestAddBuf[6+1];//目得地址
	INT8U    s_AFN;            //应用功能码
	INT16U   s_FN;             //数据单元标识
	INT8U    s_DataBuf[Max376_2ReadLen];	//数据单元
	INT16U   s_DataLen;				//数据单元长度//lwc 20160901 更改变量类型，适应长数据
...
typedef struct 
{
  sPartQGDW376_2_Head  s_head;
	INT8U      *s_RcvDataBuf;//应该是数据域 数据
	INT16U     s_RcvDataLen;//数据域个数
...
} sPartQGDW376_2DeCodeFrame;//解帧的数据
...
public:
	CGW13762(void);
	~CGW13762(void);
	INT8U   Code376_2_SlaveNodeFrame(TH_IN INT8U vSrcAfn,TH_IN INT16U vSrcFn,TH_IN const sPartQGDW376_2_Head  downframe,TH_OUT  sPartQGDW376_2CreatFrame &sQGDW376_2UpFrame);
	INT8U   Code376_2_SlaveBufFrame(TH_IN INT8U vSrcAfn,TH_IN INT16U vSrcFn,INT8U *pSrcRcvBuf,INT16U vSrcRcvLen,TH_IN const sPartQGDW376_2_Head  downframe,TH_OUT  sPartQGDW376_2CreatFrame &sQGDW376_2UpFrame);
	INT8U   Code376_2_SlaveBufNodeFrame(TH_IN INT8U vSrcAfn,TH_IN INT16U vSrcFn,INT8U *pSrcRcvBuf,INT16U vSrcRcvLen,TH_IN const sPartQGDW376_2_Head  downframe,TH_OUT  sPartQGDW376_2CreatFrame &sQGDW376_2UpFrame);
	INT8U   Code376_2_SlaveFrame(TH_IN INT8U vSrcAfn,TH_IN INT16U vSrcFn,TH_IN const sPartQGDW376_2_Head  downframe,TH_OUT  sPartQGDW376_2CreatFrame &sQGDW376_2UpFrame);
	INT8U   Code376_2_Type(struct PartQGDW376_2 SrcCodeDataFrame,INT16U vSrcDstBufLen,INT8U *pDstBuf,INT16U &vDstLen);
	INT8U   DeDecode376_2(const INT8U *pSrcBuf,INT16U vSrcLen,INT16U vDstBufLen,struct PartQGDW376_2 &DstDecodeDataFrame);
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	INT8U  Code376_2_F0F008Data(TH_IN INT8U vSrcCn,TH_IN INT8U *vSrcMsgAddr,TH_IN INT8U vSrcAfn,TH_IN INT16U vSrcFn, TH_IN INT8U *pSrcSendBuf,TH_IN INT16U vSrcSendLen,TH_OUT  sPartQGDW376_2CreatFrame &sQGDW376_2UpFrame);
    INT8U  Code376_2_HostFrame(TH_IN INT8U vSrcAfn,TH_IN INT16U vSrcFn,TH_OUT  sPartQGDW376_2CreatFrame &sQGDW376_2UpFrame);
    INT8U  Code376_2_HostNodeFrame(TH_IN const INT8U *pSrcAddBuf,TH_IN INT8U vSrcAfn,TH_IN INT16U vSrcRcvLen,TH_OUT  sPartQGDW376_2CreatFrame &sQGDW376_2UpFrame);
	INT8U  Code376_2_HostBufFrame(TH_IN INT8U vSrcAfn,TH_IN INT16U vSrcFn,TH_IN INT8U *pSrcRcvBuf,TH_IN INT16U vSrcRcvLen,TH_OUT  sPartQGDW376_2CreatFrame &sQGDW376_2UpFrame);
    INT8U  Code376_2_HostBufNodeFrame(TH_IN const INT8U *pSrcAddBuf,TH_IN INT8U vSrcAfn,TH_IN INT16U vSrcFn,TH_IN INT8U *pSrcRcvBuf,TH_IN INT16U vSrcRcvLen,TH_OUT  sPartQGDW376_2CreatFrame &sQGDW376_2UpFrame);
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  private: 
	  	sPartQGDW376_2_Head   Init376_2HostFrameNoNode( TH_IN INT8U vSrcAfn, TH_IN INT16U vSrcFn);
	sPartQGDW376_2_Head   Init376_2HostFrameNode( TH_IN const INT8U *pSrcAddBuf,TH_IN INT8U vSrcAfn, TH_IN INT16U vSrcFn);
//-----------------------------------------------------------------------------
//name : sPartQGDW376_2_Head  Init376_2UpFrame(INT8U *vDestAddBuf,INT8U vSrcAfn,INT16U vSrcFn);
//Function:上行帧格式
// 参数描述:
//   Input：
//        MsgComFg-----------------信息域中的通信模标识
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~	
	sPartQGDW376_2_Head Init376_2UpFrame(TH_IN const INT8U *pSrcAddBuf,TH_IN INT8U vSrcAfn,TH_IN INT16U vSrcFn,INT8U type =0);
public:
	 INT8U m_376seq;
