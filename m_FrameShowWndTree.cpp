...
IMPLEMENT_DYNAMIC(m_FrameShowWndTree, CDockablePane)

m_FrameShowWndTree::m_FrameShowWndTree()
{
...
BEGIN_MESSAGE_MAP(m_FrameShowWndTree, CDockablePane)
	ON_WM_SIZE()
	ON_WM_CREATE()
END_MESSAGE_MAP()
...
// m_FrameShowWndTree 消息处理程序




void m_FrameShowWndTree::OnSize(UINT nType, int cx, int cy)
{
...
int m_FrameShowWndTree::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
...
void m_FrameShowWndTree::InsertItemToTreeList(CString strTableName)
{
...
void m_FrameShowWndTree::MyExpandTree(HTREEITEM hTreeItem)  
{  
